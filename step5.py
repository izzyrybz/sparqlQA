...
def get_tag_me_entities(query):
    ...
    try:
        ...
        entities = []
        #print("did we crash after response?")
...
if __name__ == "__main__":
    print("data/LC-QUAD/linked_test.json")
    with open('data/LC-QUAD/linked_test.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
