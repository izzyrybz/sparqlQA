...
def get_earl_entities(query):
    ...
    '''response = requests.post(' http://openie.allenai.org/extract',
                             json={"text": query})
    #print("we are past this broken link")
    print("This is the response.text that is generated on line 65:",response.text)'''
    ...
    print("This is the result earl gives" ,result)'''
...
if __name__ == "__main__":
    ...
    #it is like the obama request, that you can ask about birthcity, age, ect . these are properties
    ...
    for item in data:
        ...
        #earl ={'entities': , 'relations':, 'confidence':,}

        tagme_e = get_tag_me_entities(query)
        print("This is tagme" ,tagme_e)
        ...
        print("This is e_falcon, r_falcon" ,e_falcon, r_falcon)
        if len(e_falcon) > 0:
